...
const app_design = () => {
  return (
    <div className='text-white'>
      <div className='w-full relative overflow-hidden bg-[#E7816B] p-5 m-auto sm:h-[250px] sm:w-3/4 sm:rounded-xl'>
      <img className='absolute w-1/2' src="/images/bg-pattern-small-circle.svg" alt="" />
        <div className='w-11/12 p-10 m-auto text-center'>
          ...
          <p className='sm:w-1/2 sm:m-auto'>Our mobile designs bring intuitive digital solutions to your customers right at their fingertips.</p>
        </div>
      </div>
      <div className='flex sm:w-3/4 justify-center flex-wrap m-auto'>
